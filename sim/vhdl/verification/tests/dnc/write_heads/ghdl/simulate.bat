...
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/tests/design/dnc/write_heads/accelerator_write_heads_pkg.vhd
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/tests/design/dnc/write_heads/accelerator_write_heads_stimulus.vhd
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/tests/design/dnc/write_heads/accelerator_write_heads_testbench.vhd
